#!/usr/bin/env python3
"""
Test the SceneGraphEncoderSimple (2-layer, 6-dim nodes, 6-dim edges)
...
def main():
    print(f"\n{'#' * 60}")
    print(f"  Testing {MODEL_TYPE} model (SceneGraphEncoderSimple)")
    ...
    print("=" * 60)
    print("  ALL TESTS PASSED — simple model (2-layer, 6-dim)")
    print("=" * 60)
