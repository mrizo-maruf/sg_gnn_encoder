#!/usr/bin/env python3
"""
Test the SceneGraphEncoderLight (2-layer, 10-dim nodes, 13-dim edges)
...
from model import SceneGraphEncoderLight
...
def main():
    print(f"\n{'#' * 60}")
    print(f"  Testing {MODEL_TYPE} model (SceneGraphEncoderLight)")
    ...
    print("=" * 60)
    print("  ALL TESTS PASSED — 2layer model")
    print("=" * 60)
